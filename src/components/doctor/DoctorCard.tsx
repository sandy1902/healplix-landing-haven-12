        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full p-4 bg-[#9b87f5]/5 rounded-lg">
              <h4 className="font-semibold text-[#1A1F2C] mb-3 text-center md:text-left">
                {doctor.clinicName}
              </h4>
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              {doctor.videoConsultation.available && (
                <div className="flex flex-col md:flex-row items-center justify-between p-3 bg-[#9b87f5]/10 rounded-lg gap-2">
              ...
              {doctor.clinicVisit.available && (
                <div className="flex flex-col md:flex-row items-center justify-between p-3 bg-[#7E69AB]/10 rounded-lg gap-2">
